...
//	}
	...
	public String dashboard(Model model) {
		...
		if(SecurityContextHolder.getContext().getAuthentication().isAuthenticated()) {
			...
			if(memberShipPaymentDetail != null) {
				...
				MemberShipPaymentDetail memberShipPaymentDetail2 = userService.findMemberShipByUserName(user.getEmail());
	...
	public String membership(@RequestParam String value,Model model, HttpSession session) {
		...
		if(SecurityContextHolder.getContext().getAuthentication().isAuthenticated()) {
			...
			memberShipDetail.setPaymenDateTime(LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss.SS")));
	...
	public String paymentConform(HttpSession session) {
		...
		MemberShipPaymentDetail memberShipPaymentDetail = (MemberShipPaymentDetail)session.getAttribute("tempMemberShipDetail");
		if(memberShipPaymentDetail != null) {
	...
	public String setProfile_form(@RequestParam String fullName,String phone,String gender,int height,Float weight,int age) {
